  ...
  return (
    <div className="flex w-full h-screen overflow-hidden bg-gray-100 dark:bg-[#1A1C20] transition-all">
      ...
      <div className="hidden md:block w-96 bg-white dark:bg-[#1A1C21] p-4 border-l border-gray-200 dark:border-gray-700">
        <h2 className="text-lg font-semibold mb-6 text-gray-800 dark:text-gray-100 text-center">CONTRIBUTORS</h2>
        ...
        <div className="mt-16 flex items-center justify-center gap-2">
          <span className="text-lg font-semibold text-gray-700 dark:text-gray-300">View our project on &gt;</span>
          <a
