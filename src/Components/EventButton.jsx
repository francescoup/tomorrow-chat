export default function EventButton({
  ...
  const base = `inline-flex items-center justify-center gap-2 rounded-full w-full px-4 py-2.5 text-sm font-semibold bg-blue-600 text-white hover:bg-blue-600-700 transition disabled:opacity-60 disabled:cursor-not-allowed ${s.btn} ${className}`;
